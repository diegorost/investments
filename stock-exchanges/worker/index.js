...
const YAHOO_MARKETS = [
  ...
  { name: "GDX",   ticker: "GDX",  region: "MINERS", icon: "🥇" },
  { name: "NUGT",  ticker: "NUGT", region: "MINERS", icon: "🥇" },
  { name: "GDXU",  ticker: "GDXU", region: "MINERS", icon: "🥇" },

  { name: "MUU",   ticker: "MUU",   region: "TECH", icon: "💾" },
  { name: "MU",    ticker: "MU",    region: "TECH", icon: "💾" },
  { name: "SNXX",  ticker: "SNXX",  region: "TECH", icon: "💾" },
  { name: "SNDK",  ticker: "SNDK",  region: "TECH", icon: "💾" },
  { name: "WDCX",  ticker: "WDCX",  region: "TECH", icon: "💾" },
  { name: "STXX",  ticker: "STXX",  region: "TECH", icon: "💾" },
  { name: "TSMX",  ticker: "TSMX",  region: "TECH", icon: "⚙️" },
  { name: "SKHX",  ticker: "SKHX",  region: "TECH", icon: "⚙️" },
  { name: "RAM",   ticker: "RAM",   region: "TECH", icon: "💾" },
  { name: "DRAM",  ticker: "DRAM",  region: "TECH", icon: "💾" },
  { name: "SOXL",  ticker: "SOXL",  region: "TECH", icon: "⚙️" },
  { name: "KLAG",  ticker: "KLAG",  region: "TECH", icon: "⚙️" },
  { name: "GEVX",  ticker: "GEVX",  region: "TECH", icon: "⚡" },
  { name: "QBTX",  ticker: "QBTX",  region: "TECH", icon: "⚛️" },
  { name: "VRTL",  ticker: "VRTL",  region: "TECH", icon: "🖥️" },
  { name: "AVGX",  ticker: "AVGX",  region: "TECH", icon: "⚙️" },
